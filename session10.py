...
def dict_approach_for_solution():
    ...
    '''
    input:takes in dictionary of profile of   10000  people generated by Faker library
...
def named_tuple_approach_fo_solution():
    '''
    input:takes in dictionary of profile of   10000  people generated by Faker library and stored in named tuple
    returns the largest blood type, mean-current_location, oldest_person_age and average age 
    '''
    start=perf_counter()
    z=[]
...
def stock_exchange_creation():
    '''
     input: Takes in info of 100 companies listed on our stock exchange
